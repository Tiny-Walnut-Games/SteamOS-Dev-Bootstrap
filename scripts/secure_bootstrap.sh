...
# Create a temporary file with security functions added
{
  ...
  echo "#     curl -fsSL https://raw.githubusercontent.com/YOUR-USERNAME/SteamOS-Dev-Bootstrap/main/bootstrap-steamos.sh -o bootstrap-steamos.sh"
  ...
  echo "#     curl -fsSL https://raw.githubusercontent.com/YOUR-USERNAME/SteamOS-Dev-Bootstrap/main/bootstrap-steamos.sh | bash"
  echo "# ============================================================================"
  echo ""
